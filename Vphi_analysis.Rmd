...
# offset of the sinus signal (see to do it another way wich is more "real like")
...
```{python}
Vmoy = np.nanmean(Vsquid, axis=2)
Vmin = np.nanmin(Vsquid, axis=2)
Vmax = np.nanmax(Vsquid, axis=2)
#Vmoy=Vsquid.mean(axis=2)
#Vmin=Vsquid.min(axis=2)
#Vmax=Vsquid.max(axis=2)
