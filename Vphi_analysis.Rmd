...
```{python}
plt.hist(data[:,9],range=[0,30], bins=30, alpha = 0.3, color= 'r' ,label="9")
plt.hist(data[:,10],range=[0,30], bins=30, alpha = 0.1, color= 'b',label="10")
#plt.hist(data[:,11],range=[0,30], bins=30, alpha = 0.5, color= 'g', label="11")
plt.legend()
```
...
plt.hist(data[:,10],range=[0,30], bins=30, alpha = 0.1, color= 'b',label="10")
plt.hist(data[:,12],range=[0,30], bins=30, alpha = 0.3, color= 'r' ,label="12")
plt.hist(data[:,11],range=[0,30], bins=30, alpha = 0.5, color= 'g', label="11")
plt.legend()
```
